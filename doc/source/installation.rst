...
Note that it is a fragment extracted only for networking-spp::
  ...
  DPDK_PORT_MAPPINGS=00:04.0#phys1#2#0xfe,00:05.0#phys2#2#0xfc02         # configration information about NICs used for SPP.

  disable_all_services      # Norimary, it is necessary and sufficient for the followong three services.
  ...
  [libvirt]
  # this is necessary if DPDK is used even on VM. To enable the VM necessary for DPDK such as SSE instruction to VM.
