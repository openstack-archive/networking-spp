...
+-------------------------+------------------------------+-------------------------------------------+
| DPDK_GIT_TAG            | v17.08                       | branch(tag) of DPDK                       |
+-------------------------+------------------------------+-------------------------------------------+
...
physical_network
  physical_network of the neutron network correspondding to the NIC.
...
Is is recommended that hugepages are allocated at kernel boot, but it
...
It must be specified and is valied when SPP_ALLOCATE_HUGEPAGES is True.
